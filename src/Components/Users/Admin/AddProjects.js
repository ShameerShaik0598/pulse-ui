...
function AddProjects() {
  ...
  const handleAddProject = async (project) => {
    ...
    let res = await axios.post(
      "http://localhost:1000/admin/add-project",
      project,
      {
        headers: {
        ...
        <form className="form" onSubmit={handleSubmit(handleAddProject)}>
          ...
          <div className="m-3">
            <input
              ...
              {...register("project_name", { required: "Project is required" })}
          ...
          <div className="m-3">
            ...
            >
              ...
              {managers.pm.map((pm, index) => (
                <option key={index} value={pm.email}>
                  {" "}
                  {/* {console.log("blahhh", pm)} */}
                  {pm.first_name}
                </option>
              ))}
            </select>
